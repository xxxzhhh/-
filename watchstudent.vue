<template>
  <div class="main">
    <div style="text-align: center; font-family: youyuan; font-weight:500;position: relative;left: 35%;">学 生 成 绩 分 析</div>
    <div style="height: 150px; border: 1px solid rgb(216, 214, 214);position: relative;left: 35%;">
      <div class="first">
        <span style="margin-left: 26%;position: relative;left: 11.9%;">请输入待查询学生学号</span><el-input v-model="input1"
          placeholder="输入学号进行查询"
